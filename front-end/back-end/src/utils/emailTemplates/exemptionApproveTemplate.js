export const approveExemptionTemplate = (exemptionId) => `
   ...
   <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9f9f9; 
            ...
            <img src="https://lh3.googleusercontent.com/a/ACg8ocISTyKQ5pLt5y-PF1oTgsISBgIgUxQSC42lJ-JSOwj2wtCu9EaX4l0dnlraTkhwfliMThr7jcWGoLcytOZCswnpFL9KHVg=s324-c-no" 
                 ...
                 style="max-width: 150px; height: auto;">
                    ...
                    <h2 style="color: #FFA726;">Exemption Approved</h2>
                    <p style="color: #333;">Your exemption application (${exemptionId}) has been approved.</p>
</div>
`;
