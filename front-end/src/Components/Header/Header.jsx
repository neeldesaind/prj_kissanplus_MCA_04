            ...
            <div className="flex items-center lg:order-2">
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none dark:focus:ring-primary-800 flex items-center cursor-pointer"
                >
                  Get started
                  <HiChevronDown
